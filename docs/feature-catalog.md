...
| `invite-signup-password` | Password input with a show/hide eye icon on the right. Helper: `At least 8 characters.` | idle, focused, invalid (validation error in shared error region) |
